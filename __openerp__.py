...
#
##############################################################################
# Original by NovaPoint Group LLC
# Extensively modified by ryepdx from January 2014 through January 2015

{
    'name': 'Shipping API UPS',
    'version': '3.0',
    'category': 'Generic Modules/Others',
    'description': "Shipping with UPS.",
    'author': ['NovaPoint Group LLC', 'RyePDX LLC'],
    'website': ['http://www.novapointgroup.com', 'http://www.ryepdx.com/'],
    'depends': ['shipping_api', 'sale_negotiated_shipping', 'partner_address_validation'],
    'data': [
